...
- The same checks now also hold the family's register of machine documents to all three projects at once. Every document this project writes, and every one Horde reads, must have a row on Yggdrasil's family-contracts page saying who produces it and who consumes it — so a document added on one side of a seam and never written down turns the check red, naming the file and the line it was found on.
