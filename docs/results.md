...
## Feature-fingerprint lab (149–156), research on an extension — negative on the headline claim
...
design consequence is recorded in the research memo: a bundle-size policy with an origin, a soft brief-coupling
gate, no fingerprint gate.
