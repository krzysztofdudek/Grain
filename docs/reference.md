...
| `what <words>` | `--json` | the concept card for a word or phrase: declarations, matching indexed values, spread across modules, sibling values, commit mentions, file-level fan-in |
