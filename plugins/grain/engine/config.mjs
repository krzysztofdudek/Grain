...
const ALL_EXT2GRAMMAR = { '.ts': 'typescript', '.mts': 'typescript', '.cts': 'typescript', '.tsx': 'tsx', '.js': 'javascript', '.mjs': 'javascript', '.cjs': 'javascript', '.jsx': 'javascript',
  ...
  '.json': 'json', '.yaml': 'yaml', '.yml': 'yaml', '.toml': 'toml', '.properties': 'properties' };
...
export const EXT_ALT = Object.fromEntries(Object.entries(ALL_EXT_ALT)
  .filter(([e, g]) => EXT2GRAMMAR[e] && GRAMMARS.includes(g)));
...
export const CFG = { lambda: 8, minRaw: 5, minEff: 3, valueDfMin: 2, valueDfMaxShare: 0.2, ambGap: 0.15, minMemb: 0.35,
  ...
  cochangeMinSup: 8, cochangeMinConf: 0.75, megaCap: 30, fpsCap: 20000, // per-commit footprint history retained (§J2.1); newest kept, oldest dropped
