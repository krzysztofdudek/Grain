...
test('J1.2: check <file> --json output shape is unchanged (no cochangePartners or other review-only keys) — updated for §089\'s additive `disclosures[]` and the additive `location`', () => {
