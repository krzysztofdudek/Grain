...
test("csharp-generic-attribute", async () => {
  await runCase({
    files: [
...
class C { }
` },
    { path: "src/n/Bar.cs", language: "csharp", code: `namespace N;
public class Bar { }
` },
    { path: "src/a/CacheAttribute.cs", language: "csharp", code: `namespace N;
public class CacheAttribute<T> : System.Attribute { }
` },
  ],
    edges: [{ file: "src/c/Use.cs", line: 2, node: "n" }, { file: "src/c/Use.cs", line: 2, node: "a" }],
    silence: false,
  });
});
