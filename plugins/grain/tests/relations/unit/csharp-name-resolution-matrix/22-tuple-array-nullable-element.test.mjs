...
test("csharp-tuple-array-nullable-element", async () => {
  await runCase({
    files: [
    { path: "src/c/Use.cs", language: "csharp", code: `using N;
class C { (Foo, Bar) _t; Baz[] _a; Qux? _n; }
` },
    { path: "src/n/Types.cs", language: "csharp", code: `namespace N;
public class Foo {}
public class Bar {}
public class Baz {}
public struct Qux {}
` },
    ...
    edges: [{ file: "src/c/Use.cs", line: 2, node: "n" }, { file: "src/c/Use.cs", line: 2, node: "n" }, { file: "src/c/Use.cs", line: 2, node: "n" }, { file: "src/c/Use.cs", line: 2, node: "n" }],
    silence: false,
  });
});
