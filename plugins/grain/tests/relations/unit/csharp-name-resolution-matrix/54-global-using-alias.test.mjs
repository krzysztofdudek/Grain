...
test("csharp-global-using-alias", async () => {
  await runCase({
    files: [
    { path: "src/g/Globals.cs", language: "csharp", code: `global using Cust = MyApp.Models.Customer;
` },
    { path: "src/c/Use.cs", language: "csharp", code: `class C { Cust c; }
` },
    { path: "src/m/Customer.cs", language: "csharp", code: `namespace MyApp.Models;
public class Customer { }
` },
  ],
    edges: [{ file: "src/c/Use.cs", line: 1, node: "m" }],
    silence: false,
  });
});
