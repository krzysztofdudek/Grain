...
test("csharp-block-namespace-nested-fqn", async () => {
  await runCase({
    files: [
    { path: "src/t/T.cs", language: "csharp", code: `namespace A.B { namespace C { class T { } } }
` },
    { path: "src/c/Use.cs", language: "csharp", code: `namespace Other;
class D { void M() { var o = new A.B.C.T(); } }
` },
  ],
    edges: [{ file: "src/c/Use.cs", line: 2, node: "t" }],
    silence: false,
  });
});
