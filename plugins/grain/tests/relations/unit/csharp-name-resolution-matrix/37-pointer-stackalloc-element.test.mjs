...
test("csharp-pointer-stackalloc-element", async () => {
  await runCase({
    files: [
    { path: "src/c/Use.cs", language: "csharp", code: `using N;
class C { unsafe void M() { Foo* p = null; var s = stackalloc Foo[4]; } }
` },
    { path: "src/n/Foo.cs", language: "csharp", code: `namespace N;
public struct Foo {}
` },
  ],
    edges: [{ file: "src/c/Use.cs", line: 2, node: "n" }, { file: "src/c/Use.cs", line: 2, node: "n" }],
    silence: false,
  });
});
