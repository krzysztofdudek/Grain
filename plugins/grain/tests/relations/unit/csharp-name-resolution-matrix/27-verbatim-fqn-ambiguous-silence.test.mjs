...
test("csharp-verbatim-fqn-ambiguous-silence", async () => {
  await runCase({
    files: [
    { path: "src/z/Use.cs", language: "csharp", code: `namespace MyApp.Z;
class Use { void M() { var t = new MyApp.Dup.Thing(); } }
` },
    { path: "src/x/Thing.cs", language: "csharp", code: `namespace MyApp.Dup;
public class Thing {}
` },
    { path: "src/y/Thing.cs", language: "csharp", code: `namespace MyApp.Dup;
public class Thing {}
` },
  ],
    edges: [],
