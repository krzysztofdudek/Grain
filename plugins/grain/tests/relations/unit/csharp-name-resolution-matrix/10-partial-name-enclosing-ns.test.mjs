...
test("csharp-partial-name-enclosing-ns", async () => {
  await runCase({
    files: [
    { path: "src/c/Use.cs", language: "csharp", code: `namespace A;
class C : B.Type { }
` },
    { path: "src/n/Type.cs", language: "csharp", code: `namespace A.B;
public class Type {}
` },
    { path: "src/x/Type.cs", language: "csharp", code: `namespace B;
public class Type {}
` },
  ],
    edges: [{ file: "src/c/Use.cs", line: 2, node: "n" }],
    silence: false,
  });
});
