...
test("csharp-using-static-no-namespace-prefix", async () => {
  await runCase({
    files: [
    { path: "src/c/Use.cs", language: "csharp", code: `using static Ext.Calc;
class D : Baz { }
` },
    { path: "src/n/Baz.cs", language: "csharp", code: `namespace Ext;
public class Baz { }
` },
  ],
    edges: [],
