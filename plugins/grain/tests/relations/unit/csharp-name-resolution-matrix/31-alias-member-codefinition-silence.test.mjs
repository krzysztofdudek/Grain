...
test("csharp-alias-member-codefinition-silence", async () => {
  await runCase({
    files: [
    { path: "src/c/Use.cs", language: "csharp", code: `using I = N.Thing;
namespace App;
class C : I { }
` },
    { path: "src/n/Thing.cs", language: "csharp", code: `namespace N;
public class Thing {}
` },
    { path: "src/app/I.cs", language: "csharp", code: `namespace App;
public class I {}
` },
  ],
    edges: [],
