...
test("csharp-nearer-scope-hiding", async () => {
  await runCase({
    files: [
    { path: "src/c/Use.cs", language: "csharp", code: `using Ext;
namespace App;
class C : Repo { }
` },
    { path: "src/local/Repo.cs", language: "csharp", code: `namespace App;
public class Repo {}
` },
    { path: "src/ext/Repo.cs", language: "csharp", code: `namespace Ext;
public class Repo {}
` },
  ],
    edges: [{ file: "src/c/Use.cs", line: 3, node: "local" }],
    silence: false,
  });
});
