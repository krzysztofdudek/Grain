...
test("csharp-global-using-sibling-file", async () => {
  await runCase({
    files: [
    { path: "src/g/Globals.cs", language: "csharp", code: `global using N;
` },
    { path: "src/c/Use.cs", language: "csharp", code: `class C : Type { }
` },
    { path: "src/n/Type.cs", language: "csharp", code: `namespace N;
public class Type {}
` },
  ],
    edges: [{ file: "src/c/Use.cs", line: 1, node: "n" }],
    silence: false,
  });
});
