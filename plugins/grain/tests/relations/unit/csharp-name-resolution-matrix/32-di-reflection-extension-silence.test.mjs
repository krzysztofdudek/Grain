...
test("csharp-di-reflection-extension-silence", async () => {
  await runCase({
    files: [
    { path: "src/c/Use.cs", language: "csharp", code: `using Microsoft.Extensions.DependencyInjection;
class Startup {
...
` },
    { path: "src/pay/Gateway.cs", language: "csharp", code: `namespace MyApp.Pay;
