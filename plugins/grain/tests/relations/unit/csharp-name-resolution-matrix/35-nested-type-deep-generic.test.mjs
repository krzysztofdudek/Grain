...
test("csharp-nested-type-deep-generic", async () => {
  await runCase({
    files: [
    { path: "src/c/Use.cs", language: "csharp", code: `namespace App;
class C { Outer.Mid.Inner f; }
` },
    { path: "src/o/Outer.cs", language: "csharp", code: `namespace App;
public class Outer { public class Mid { public class Inner {} } }
` },
  ],
    edges: [{ file: "src/c/Use.cs", line: 2, node: "o" }],
    silence: false,
  });
});
