...
test("csharp-deep-enclosing-chain-walk", async () => {
  await runCase({
    files: [
    { path: "src/c/Use.cs", language: "csharp", code: `namespace App.Services.Sub;
class C { void M() { var o = new Models.Order(); } }
` },
    { path: "src/m/Order.cs", language: "csharp", code: `namespace App.Services.Models;
public class Order {}
` },
  ],
    edges: [{ file: "src/c/Use.cs", line: 2, node: "m" }],
    silence: false,
  });
});
