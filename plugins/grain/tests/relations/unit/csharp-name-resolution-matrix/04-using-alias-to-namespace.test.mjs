...
test("csharp-using-alias-to-namespace", async () => {
  await runCase({
    files: [
    { path: "src/c/Use.cs", language: "csharp", code: `using Al = N.Sub;
namespace App;
class C : Al.Type { }
` },
    { path: "src/n/Type.cs", language: "csharp", code: `namespace N.Sub;
public class Type {}
` },
  ],
    edges: [{ file: "src/c/Use.cs", line: 3, node: "n" }],
    silence: false,
  });
});
