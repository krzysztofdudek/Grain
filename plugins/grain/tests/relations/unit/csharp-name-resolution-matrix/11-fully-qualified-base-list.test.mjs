...
test("csharp-fully-qualified-base-list", async () => {
  await runCase({
    files: [
    { path: "src/c/Use.cs", language: "csharp", code: `class C : A.B.C.Type { }
` },
    { path: "src/t/Type.cs", language: "csharp", code: `namespace A.B.C;
public class Type {}
` },
  ],
    edges: [{ file: "src/c/Use.cs", line: 1, node: "t" }],
    silence: false,
  });
});
