...
test("csharp-global-using-static-target-edge", async () => {
  await runCase({
    files: [
    { path: "src/g/Globals.cs", language: "csharp", code: `global using static N.MathHelpers;
` },
    { path: "src/n/MathHelpers.cs", language: "csharp", code: `namespace N;
public static class MathHelpers { }
` },
  ],
    edges: [{ file: "src/g/Globals.cs", line: 1, node: "n" }],
    silence: false,
  });
});
