// Reference-catalogue case `php-instanceof-relative-silence` (Yggdrasil reference/relations/php/php-instanceof-relative-silence.md), driven end-to-end
...
//
// Rule: `$x instanceof Timer` with no leading backslash names a namespace-relative class
// reference (Rule 6). It is a usage-site form — the import-only model emits nothing, rather
// than guess at a global `Timer`.
...
test("php-instanceof-relative-silence", async () => {
  const files = [
