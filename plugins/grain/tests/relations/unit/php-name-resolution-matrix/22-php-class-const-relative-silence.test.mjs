// Reference-catalogue case `php-class-const-relative-silence` (Yggdrasil reference/relations/php/php-class-const-relative-silence.md), driven end-to-end
...
//
// Rule: `Gateway::class` with no leading backslash is a compile-time class-name literal
// resolved against the current namespace + `use` imports (Rule 6). It is a genuine static
// reference, but a namespace-relative one — the import-only model declines to surface it
// (silence), a tolerated recall miss.
...
test("php-class-const-relative-silence", async () => {
  const files = [
