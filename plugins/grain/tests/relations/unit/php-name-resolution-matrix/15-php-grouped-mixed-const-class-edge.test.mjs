// Reference-catalogue case `php-grouped-mixed-const-class-edge` (Yggdrasil reference/relations/php/php-grouped-mixed-const-class-edge.md), driven end-to-end
...
//
// Rule: A grouped use may carry the `const` keyword on an INDIVIDUAL clause: `use
// App\Pkg\{const MAX, Gateway};`. Only that clause is a constant import (no class edge);
// sibling CLASS clauses still import classes. Dropping the whole group on seeing one `const`
// keyword would lose the sibling class edge; emitting `MAX` as a class would be a false
// positive.
...
test("php-grouped-mixed-const-class-edge", async () => {
  const files = [
