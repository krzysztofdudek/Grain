// Reference-catalogue case `php-psr4-two-roots-one-hit-edge` (Yggdrasil reference/relations/php/php-psr4-two-roots-one-hit-edge.md), driven end-to-end
...
//
// Rule: A PSR-4 prefix may map to several base directories: `App\` → `["src", "lib"]`. When the
...
test("php-psr4-two-roots-one-hit-edge", async () => {
  const files = [
