// Reference-catalogue case `php-dynamic-new-expr-silence` (Yggdrasil reference/relations/php/php-dynamic-new-expr-silence.md), driven end-to-end
...
//
// Rule: `new ($f())()` instantiates the class named by a runtime expression (PHP 8.0+) — no
...
test("php-dynamic-new-expr-silence", async () => {
  const files = [
