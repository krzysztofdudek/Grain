// Reference-catalogue case `php-param-return-property-relative-silence` (Yggdrasil reference/relations/php/php-param-return-property-relative-silence.md), driven end-to-end
...
//
// Rule: Class names in parameter, return, and property type positions — `private Repo $r;`,
// `function m(Logger $l): Result` — written without a leading backslash are namespace-relative
// usage-site references resolved by the §rules precedence (including union / intersection / DNF
// composites and 8.3 typed constants). The import-only model emits nothing for them.
...
test("php-param-return-property-relative-silence", async () => {
  const files = [
