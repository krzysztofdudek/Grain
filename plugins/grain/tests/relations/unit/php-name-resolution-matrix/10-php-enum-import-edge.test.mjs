// Reference-catalogue case `php-enum-import-edge` (Yggdrasil reference/relations/php/php-enum-import-edge.md), driven end-to-end
...
//
// Rule: An enum NAME is a class-like symbol, name-resolved identically to a class. So `use
// App\Enums\Suit;` is an A1-style class import: the extractor emits the FQN `App\Enums\Suit`
// (the `use` operand is treated uniformly across class / interface / trait / enum), and the
// resolver maps it to the enum's file by PSR-4.
...
test("php-enum-import-edge", async () => {
  const files = [
    { path: "src/Enums/Suit.php", language: "php", code: "<?php\nnamespace App\\Enums;\nenum Suit { case Hearts; case Spades; }\n" },
  ...
  const expectEdges = [
    { fromFile: "src/Order/Handler.php", line: 3, node: "Enums" },
  ];
