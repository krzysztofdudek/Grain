// Reference-catalogue case `php-dynamic-class-alias-silence` (Yggdrasil reference/relations/php/php-dynamic-class-alias-silence.md), driven end-to-end
...
//
// Rule: `class_alias("App\\Foo", "F")` creates an alias at RUNTIME from string-literal operands
// — invisible to a static tool. The extractor emits nothing; the class name lives only inside a
// string argument.
...
test("php-dynamic-class-alias-silence", async () => {
  const files = [
