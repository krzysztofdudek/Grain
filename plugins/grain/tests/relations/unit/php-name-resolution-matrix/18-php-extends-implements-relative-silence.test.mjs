// Reference-catalogue case `php-extends-implements-relative-silence` (Yggdrasil reference/relations/php/php-extends-implements-relative-silence.md), driven end-to-end
...
//
// Rule: A supertype list `class C extends Base implements Flowable, Other` names class /
// interface references without a leading backslash — namespace-relative usage sites resolved by
// the §rules precedence. The import-only model emits nothing for any of them; resolving a bare
// supertype name would reintroduce the no-global-fallback / sibling-same-name trap.
...
test("php-extends-implements-relative-silence", async () => {
  const files = [
    { path: "src/Base/Base.php", language: "php", code: "<?php\nnamespace App\\Base;\nclass Base {}\n" },
