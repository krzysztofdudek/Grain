// Reference-catalogue case `php-use-const-no-edge` (Yggdrasil reference/relations/php/php-use-const-no-edge.md), driven end-to-end
...
//
// Rule: `use const App\Util\MAX;` imports a CONSTANT into the constant table, not a class. The
// extractor recognizes the declaration-level `const` keyword and skips the whole declaration —
// no class dependency exists. Treating it as a class import would fabricate an edge to a
// non-existent class FQN.
...
test("php-use-const-no-edge", async () => {
  const files = [
    { path: "src/Util/constants.php", language: "php", code: "<?php\nnamespace App\\Util;\nconst MAX = 1;\n" },
