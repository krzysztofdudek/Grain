// Reference-catalogue case `php-dynamic-var-static-call-silence` (Yggdrasil reference/relations/php/php-dynamic-var-static-call-silence.md), driven end-to-end
...
//
// Rule: `$var::go()` dispatches a static call through a variable at RUNTIME — there is no
// static class-name token. The extractor emits nothing; resolving the variable would be a
// guess.
...
test("php-dynamic-var-static-call-silence", async () => {
  const files = [
