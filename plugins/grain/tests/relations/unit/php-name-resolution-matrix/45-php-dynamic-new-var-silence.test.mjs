// Reference-catalogue case `php-dynamic-new-var-silence` (Yggdrasil reference/relations/php/php-dynamic-new-var-silence.md), driven end-to-end
...
//
// Rule: `new $var()` names a class through a string variable resolved at RUNTIME — the `use`
// import table is NEVER applied to a dynamic name, and it is treated as effectively
// fully-qualified. Nothing is statically resolvable; resolving `$var` to any class is a pure
// guess and a false positive. The extractor emits nothing.
...
test("php-dynamic-new-var-silence", async () => {
  const files = [
