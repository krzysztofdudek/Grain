// Reference-catalogue case `php-grouped-use-function-no-edge` (Yggdrasil reference/relations/php/php-grouped-use-function-no-edge.md), driven end-to-end
...
//
// Rule: In `use function App\Util\{format, trim};` the `function` keyword sits directly under
// the declaration, so EVERY clause it introduces is a function import. The extractor skips the
// whole declaration — no class edge for any clause. Emitting any clause as a class FQN would be
// a false positive.
...
test("php-grouped-use-function-no-edge", async () => {
  const files = [
