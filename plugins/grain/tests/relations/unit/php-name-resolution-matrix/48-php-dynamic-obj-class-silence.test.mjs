// Reference-catalogue case `php-dynamic-obj-class-silence` (Yggdrasil reference/relations/php/php-dynamic-obj-class-silence.md), driven end-to-end
...
//
// Rule: `$obj::class` (PHP 8.0+) equals `get_class($obj)` at runtime — it is not a static
...
test("php-dynamic-obj-class-silence", async () => {
  const files = [
