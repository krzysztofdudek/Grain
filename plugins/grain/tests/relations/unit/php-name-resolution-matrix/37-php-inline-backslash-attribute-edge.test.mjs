// Reference-catalogue case `php-inline-backslash-attribute-edge` (Yggdrasil reference/relations/php/php-inline-backslash-attribute-edge.md), driven end-to-end
...
//
// Rule: A leading-backslash attribute `#[\App\Http\Route("/x")]` is an absolute class reference
...
test("php-inline-backslash-attribute-edge", async () => {
  const files = [
  ...
  const expectEdges = [
    { fromFile: "src/Order/Handler.php", line: 3, node: "Http" },
  ];
