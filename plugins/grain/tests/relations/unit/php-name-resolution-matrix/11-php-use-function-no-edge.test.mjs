// Reference-catalogue case `php-use-function-no-edge` (Yggdrasil reference/relations/php/php-use-function-no-edge.md), driven end-to-end
...
//
// Rule: `use function App\Util\format;` imports a FUNCTION into the function table, not a
// class. The extractor recognizes the declaration-level `function` keyword and skips the whole
// declaration — no class dependency exists. Treating it as a class import would fabricate an
// edge to a non-existent class FQN. Recall is unaffected: functions are not nodes.
...
test("php-use-function-no-edge", async () => {
  const files = [
