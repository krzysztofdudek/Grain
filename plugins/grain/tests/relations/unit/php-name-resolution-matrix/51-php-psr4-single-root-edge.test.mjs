// Reference-catalogue case `php-psr4-single-root-edge` (Yggdrasil reference/relations/php/php-psr4-single-root-edge.md), driven end-to-end
...
//
// Rule: A single-root PSR-4 prefix `App\` → `src/` maps the imported FQN `App\Payment\Gateway`
...
test("php-psr4-single-root-edge", async () => {
  const files = [
