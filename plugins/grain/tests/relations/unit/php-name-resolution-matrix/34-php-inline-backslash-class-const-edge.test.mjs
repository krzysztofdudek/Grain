// Reference-catalogue case `php-inline-backslash-class-const-edge` (Yggdrasil reference/relations/php/php-inline-backslash-class-const-edge.md), driven end-to-end
...
//
// Rule: `\App\Pay\Gateway::class` with a leading backslash is an absolute class-name literal
// (Rule 1) — a class-constant access in a class-autoload position. It is shadow-free, so the
// extractor emits `App\Pay\Gateway` and the resolver maps it by PSR-4.
...
test("php-inline-backslash-class-const-edge", async () => {
  const files = [
