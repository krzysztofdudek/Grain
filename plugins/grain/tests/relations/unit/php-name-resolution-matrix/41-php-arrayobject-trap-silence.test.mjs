// Reference-catalogue case `php-arrayobject-trap-silence` (Yggdrasil reference/relations/php/php-arrayobject-trap-silence.md), driven end-to-end
...
//
// Rule: `new ArrayObject()` inside a namespace resolves to `A\B\C\ArrayObject` by
...
test("php-arrayobject-trap-silence", async () => {
  const files = [
    { path: "src/Std/ArrayObject.php", language: "php", code: "<?php\nnamespace App\\Std;\nclass ArrayObject {}\n" },
