// Reference-catalogue case `php-enum-case-relative-silence` (Yggdrasil reference/relations/php/php-enum-case-relative-silence.md), driven end-to-end
...
//
// Rule: An enum-case access `Suit::Hearts` with no leading backslash is a member access on the
// namespace-relative enum class `App\Suit` (Rule 6) — the case `Hearts` is a member, not a
// separate type. The enum reference is the usage-site class `Suit`, silenced like any relative
// static access; treating the case as a separate `Hearts` type would be a false positive.
...
test("php-enum-case-relative-silence", async () => {
  const files = [
