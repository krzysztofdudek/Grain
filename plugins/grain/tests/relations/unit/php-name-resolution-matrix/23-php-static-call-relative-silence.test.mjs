// Reference-catalogue case `php-static-call-relative-silence` (Yggdrasil reference/relations/php/php-static-call-relative-silence.md), driven end-to-end
...
//
// Rule: A static access on a literal class name with no leading backslash —
// `AuditLog::record("x")` — references the namespace-relative class `App\AuditLog` (Rule 6). It
// is a usage-site form; the import-only model emits nothing.
...
test("php-static-call-relative-silence", async () => {
  const files = [
