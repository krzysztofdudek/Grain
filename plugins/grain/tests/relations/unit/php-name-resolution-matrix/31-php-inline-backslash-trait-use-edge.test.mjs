// Reference-catalogue case `php-inline-backslash-trait-use-edge` (Yggdrasil reference/relations/php/php-inline-backslash-trait-use-edge.md), driven end-to-end
...
//
// Rule: An in-class trait `use \App\Mixin\Timestamps;` with a leading backslash is an ABSOLUTE
...
test("php-inline-backslash-trait-use-edge", async () => {
  const files = [
  ...
  const expectEdges = [
    { fromFile: "src/Order/Handler.php", line: 3, node: "Mixin" },
  ];
