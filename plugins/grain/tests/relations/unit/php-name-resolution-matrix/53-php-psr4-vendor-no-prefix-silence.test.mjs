// Reference-catalogue case `php-psr4-vendor-no-prefix-silence` (Yggdrasil reference/relations/php/php-psr4-vendor-no-prefix-silence.md), driven end-to-end
...
//
// Rule: An imported FQN whose top-level prefix is not in the project's PSR-4 map — a vendor /
...
test("php-psr4-vendor-no-prefix-silence", async () => {
  const files = [
