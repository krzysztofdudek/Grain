// Reference-catalogue case `php-attribute-relative-silence` (Yggdrasil reference/relations/php/php-attribute-relative-silence.md), driven end-to-end
...
//
// Rule: An attribute name `#[Route("/x")]` with no leading backslash is a class reference
// resolved exactly like any class name (Rule 6) — namespace-relative here. The import-only
// model emits nothing for an attribute usage; all attribute positions added across 8.0→8.5 are
// the same form in new locations.
...
test("php-attribute-relative-silence", async () => {
  const files = [
    { path: "src/Http/Route.php", language: "php", code: "<?php\nnamespace App\\Http;\nclass Route {}\n" },
