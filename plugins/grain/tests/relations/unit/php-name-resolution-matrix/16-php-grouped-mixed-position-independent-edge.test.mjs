// Reference-catalogue case `php-grouped-mixed-position-independent-edge` (Yggdrasil reference/relations/php/php-grouped-mixed-position-independent-edge.md), driven end-to-end
...
//
// Rule: The per-clause function/const guard is position-independent: in `use App\Pkg\{Gateway,
// function format};` the class clause `Gateway` precedes the function clause and still emits,
// while the `function format` clause is silent. The guard keys off each clause's own keyword,
// not its position in the group.
...
test("php-grouped-mixed-position-independent-edge", async () => {
  const files = [
