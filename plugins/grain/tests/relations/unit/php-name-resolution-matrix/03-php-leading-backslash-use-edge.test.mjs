// Reference-catalogue case `php-leading-backslash-use-edge` (Yggdrasil reference/relations/php/php-leading-backslash-use-edge.md), driven end-to-end
...
//
// Rule: In a `use \App\Foo;` import the leading backslash is unnecessary (import names are
// always fully qualified). The extractor strips exactly one leading `\`, yielding the specifier
// `App\Payment\Gateway` — identical to the plain form. Not stripping it would produce
// `\App\Payment\Gateway`, which never matches a PSR-4-keyed FQN (those carry no leading
// backslash) and would silently miss the edge.
...
test("php-leading-backslash-use-edge", async () => {
  const files = [
