// Reference-catalogue case `php-inline-backslash-param-return-property-edge` (Yggdrasil reference/relations/php/php-inline-backslash-param-return-property-edge.md), driven end-to-end
...
//
// Rule: Leading-backslash names in parameter, return, and property type positions are absolute
...
test("php-inline-backslash-param-return-property-edge", async () => {
  const files = [
    { path: "src/Dep/Repo.php", language: "php", code: "<?php\nnamespace App\\Dep;\nclass Repo {}\n" },
    { path: "src/Log/Logger.php", language: "php", code: "<?php\nnamespace App\\Log;\nclass Logger {}\n" },
    { path: "src/Res/Result.php", language: "php", code: "<?php\nnamespace App\\Res;\nclass Result {}\n" },
  ...
  const expectEdges = [
    { fromFile: "src/Order/Handler.php", line: 3, node: "Dep" },
    { fromFile: "src/Order/Handler.php", line: 3, node: "Log" },
    { fromFile: "src/Order/Handler.php", line: 3, node: "Res" },
  ];
