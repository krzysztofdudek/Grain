...
test('excluding the package falls through to the live module-as-file at the same root', () => {
  const isExcluded = (p) => p === 'mod/__init__.py';
  expect(pyResolve.resolvePythonModule('mod', 'x.py', shadowExists, isExcluded)).toBe('mod.py');
});
