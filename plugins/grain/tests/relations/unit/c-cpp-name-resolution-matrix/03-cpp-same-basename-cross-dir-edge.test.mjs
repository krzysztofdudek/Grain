...
test('cpp-same-basename-cross-dir-edge', async () => {
  await runCase(
    [
      { path: 'app/util.hpp', language: 'cpp', code: '#pragma once\nstruct AppUtil {};\n' },
      { path: 'lib/util.hpp', language: 'cpp', code: '#pragma once\nstruct LibUtil {};\n' },
      {
        path: 'app/main.cpp',
        language: 'cpp',
        code: '#include "../lib/util.hpp"\nint main() { LibUtil u; return 0; }\n',
      },
    ],
    [{ fromFile: 'app/main.cpp', line: 1, node: 'lib' }],
    false,
  );
});
