...
test('cpp-quoted-uppath-include-edge', async () => {
  await runCase(
    [
      { path: 'core/engine.hpp', language: 'cpp', code: '#pragma once\nstruct Engine {};\n' },
      {
        path: 'app/main.cpp',
        language: 'cpp',
        code: '#include "../core/engine.hpp"\nint main() { Engine e; return 0; }\n',
      },
    ],
    [{ fromFile: 'app/main.cpp', line: 1, node: 'core' }],
    false,
  );
});
