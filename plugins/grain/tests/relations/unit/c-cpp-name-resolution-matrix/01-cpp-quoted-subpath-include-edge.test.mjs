...
test('cpp-quoted-subpath-include-edge', async () => {
  await runCase(
    [
      { path: 'app/detail/helper.hpp', language: 'cpp', code: '#pragma once\nstruct Helper {};\n' },
      {
        path: 'app/main.cpp',
        language: 'cpp',
        code: '#include "detail/helper.hpp"\nint main() { Helper h; return 0; }\n',
      },
    ],
    [{ fromFile: 'app/main.cpp', line: 1, node: 'detail' }],
    false,
  );
});
