...
// Rule: an import path belonging to a DIFFERENT module (`github.com/gorilla/mux`) does
// not start with the repo's module prefix, so the gate rejects it. External-module
// source lives in the module cache, never in the repo → silence.
test('go-external-module-import-silence', async () => {
  const files = [
