...
// Rule: an import path is a `string_lit`, which may be a raw (backtick-quoted) string
// literal as well as the usual interpreted (double-quoted) one. A backtick-quoted import
// path resolves to exactly the same package directory as its double-quoted equivalent.
test('go-raw-string-import-edge', async () => {
  const files = [
