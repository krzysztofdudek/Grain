...
// Rule: a standard-library import path (`fmt`, `os`, `strings`) does not begin with
// the repo's module path, so the module-prefix gate rejects it — its source lives in
// the toolchain, not the repo. The module-prefix gate is the single most important
// false-positive guard.
test('go-stdlib-import-silence', async () => {
  const files = [
