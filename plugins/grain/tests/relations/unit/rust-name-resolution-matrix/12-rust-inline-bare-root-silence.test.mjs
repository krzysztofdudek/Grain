...
// grain adaptation: ported from Yggdrasil's reference-case-runner.ts `runCase('rust-inline-bare-
// root-silence')`, driven by reference/relations/rust/rust-inline-bare-root-silence.md. Grain has
...
const files = [
  { path: 'src/external/mod.rs', language: 'rust', code: 'pub struct Foo;\n' },
...
test('rust-inline-bare-root-silence', async () => {
