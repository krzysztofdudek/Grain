...
// grain adaptation: ported from Yggdrasil's reference-case-runner.ts `runCase('rust-macro-
// invocation-path-silence')`, driven by reference/relations/rust/rust-macro-invocation-path-
// silence.md. Grain has no reference-catalogue file or owner-index module, so the case's
...
const files = [
  { path: 'src/config/mod.rs', language: 'rust', code: 'pub const NAME: &str = "x";\n' },
  { path: 'src/c/run.rs', language: 'rust', code: 'fn f() {\n    println!("{}", crate::config::NAME);\n}\n' },
];
const configFiles = [
...
test('rust-macro-invocation-path-silence', async () => {
