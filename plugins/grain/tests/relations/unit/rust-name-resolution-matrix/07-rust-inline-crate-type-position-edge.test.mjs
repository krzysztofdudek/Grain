...
// type-position-edge')`, driven by reference/relations/rust/rust-inline-crate-type-position-
...
const files = [
  { path: 'src/orders/mod.rs', language: 'rust', code: 'pub struct Order;\n' },
  { path: 'src/c/types.rs', language: 'rust', code: 'struct S {\n    f: crate::orders::Order,\n}\n' },
];
const configFiles = [
  { path: 'Cargo.toml', code: '[package]\nname = "mycrate"\n' },
];
const expectEdges = [{ fromFile: 'src/c/types.rs', line: 2, node: 'orders' }];
const expectSilence = false;

test('rust-inline-crate-type-position-edge', async () => {
