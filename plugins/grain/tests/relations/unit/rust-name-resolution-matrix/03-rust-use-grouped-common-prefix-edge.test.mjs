...
// grain adaptation: ported from Yggdrasil's reference-case-runner.ts `runCase('rust-use-grouped-
// common-prefix-edge')`, driven by reference/relations/rust/rust-use-grouped-common-prefix-edge.md.
...
const files = [
  ...
  { path: 'src/c/use.rs', language: 'rust', code: 'use crate::a::b::{C, D};\n' },
];
const configFiles = [
...
test('rust-use-grouped-common-prefix-edge', async () => {
