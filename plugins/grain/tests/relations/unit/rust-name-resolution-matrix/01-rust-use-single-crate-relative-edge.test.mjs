...
// grain adaptation: ported from Yggdrasil's reference-case-runner.ts `runCase('rust-use-single-
// crate-relative-edge')`, driven by reference/relations/rust/rust-use-single-crate-relative-
...
const files = [
  ...
  { path: 'src/c/use.rs', language: 'rust', code: 'use crate::a::b::C;\n' },
];
const configFiles = [
...
test('rust-use-single-crate-relative-edge', async () => {
