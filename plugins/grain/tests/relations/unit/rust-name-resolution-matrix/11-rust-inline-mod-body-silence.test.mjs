...
// grain adaptation: ported from Yggdrasil's reference-case-runner.ts `runCase('rust-inline-mod-
// body-silence')`, driven by reference/relations/rust/rust-inline-mod-body-silence.md. Grain has
...
const files = [
  { path: 'src/foo/mod.rs', language: 'rust', code: 'pub struct Other;\n' },
  { path: 'src/c/lib.rs', language: 'rust', code: 'mod foo {\n    pub struct X;\n}\n' },
];
const configFiles = [
...
test('rust-inline-mod-body-silence', async () => {
