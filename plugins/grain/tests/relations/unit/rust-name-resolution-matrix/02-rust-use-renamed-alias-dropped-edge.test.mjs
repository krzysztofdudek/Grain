...
// grain adaptation: ported from Yggdrasil's reference-case-runner.ts `runCase('rust-use-renamed-
// alias-dropped-edge')`, driven by reference/relations/rust/rust-use-renamed-alias-dropped-edge.md.
...
const files = [
  { path: 'src/db/mod.rs', language: 'rust', code: 'pub struct Repository;\n' },
  { path: 'src/c/use.rs', language: 'rust', code: 'use crate::db::Repository as Repo;\n' },
];
const configFiles = [
  { path: 'Cargo.toml', code: '[package]\nname = "mycrate"\n' },
];
const expectEdges = [{ fromFile: 'src/c/use.rs', line: 1, node: 'db' }];
const expectSilence = false;

test('rust-use-renamed-alias-dropped-edge', async () => {
