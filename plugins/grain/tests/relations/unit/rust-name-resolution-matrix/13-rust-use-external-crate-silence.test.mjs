...
// grain adaptation: ported from Yggdrasil's reference-case-runner.ts `runCase('rust-use-external-
// crate-silence')`, driven by reference/relations/rust/rust-use-external-crate-silence.md. Grain
// has no reference-catalogue file or owner-index module, so the case's ## Files / ## Expect are
...
const files = [
  { path: 'src/serde/mod.rs', language: 'rust', code: 'pub struct Deserialize;\n' },
  { path: 'src/c/use.rs', language: 'rust', code: 'use serde::Deserialize;\n' },
];
const configFiles = [
...
test('rust-use-external-crate-silence', async () => {
