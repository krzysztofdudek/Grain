...
test('resolves a bare `crate` to the crate root file (the crate root module`s own file)', () => {
  ...
  try {
    ...
    // `crate` alone names the crate root module, whose file is src/lib.rs (there is no src/mod.rs or src.rs), so the empty tail binds the crate root file.
