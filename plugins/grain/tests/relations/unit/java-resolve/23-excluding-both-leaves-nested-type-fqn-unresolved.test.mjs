...
test('excluding both leaves the nested-type FQN unresolved', () => {
  const isExcluded = () => true;
  expect(javaResolve.resolveJavaFqn('com.foo.Outer.Inner', FROM, nestedDeps(isExcluded))).toBeUndefined();
});
