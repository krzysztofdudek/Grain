...
test('excluding both root files leaves a precise type import unresolved', () => {
  const isExcluded = () => true;
  expect(javaResolve.resolveJavaFqn('com.a.Zzz', FROM, shadowDeps(isExcluded))).toBeUndefined();
});
