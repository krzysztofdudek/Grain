...
test('returns undefined for a JDK stdlib type (no mapped file)', () => {
  expect(javaResolve.resolveJavaFqn('java.util.List', FROM, deps)).toBeUndefined();
  expect(javaResolve.resolveJavaFqn('javax.annotation.Nullable', FROM, deps)).toBeUndefined();
});
