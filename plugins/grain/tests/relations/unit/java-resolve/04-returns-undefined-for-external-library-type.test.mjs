...
test('returns undefined for an external-library type (no mapped file)', () => {
  expect(javaResolve.resolveJavaFqn('com.google.common.collect.ImmutableList', FROM, deps)).toBeUndefined();
});
