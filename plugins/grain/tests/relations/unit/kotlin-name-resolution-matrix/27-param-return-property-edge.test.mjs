...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-param-return-property-edge.md) and
...
const FILES = [
  ...
  {
    "path": "src/d/Logger.kt",
    "language": "kotlin",
    "code": "package com.acme\nclass Logger\n"
  },
  {
    "path": "src/d/Result.kt",
    "language": "kotlin",
    "code": "package com.acme\nclass Result\n"
  },
  {
...
test('kotlin-param-return-property-edge', async () => {
