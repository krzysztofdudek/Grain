...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-stdlib-collision-project-result-silence.md) and
...
test('kotlin-stdlib-collision-project-result-silence', async () => {
