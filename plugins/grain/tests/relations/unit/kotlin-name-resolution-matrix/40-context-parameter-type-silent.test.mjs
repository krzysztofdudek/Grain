...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-context-parameter-type-silent.md) and
...
const FILES = [
  {
    "path": "src/data/OrderRepo.kt",
    "language": "kotlin",
    "code": "package com.acme.data\nclass OrderRepo\n"
  },
  {
    "path": "src/c/Use.kt",
    "language": "kotlin",
...
test('kotlin-context-parameter-type-silent', async () => {
