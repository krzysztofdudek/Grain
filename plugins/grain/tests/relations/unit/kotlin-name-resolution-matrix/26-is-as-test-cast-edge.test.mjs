...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-is-as-test-cast-edge.md) and
...
test('kotlin-is-as-test-cast-edge', async () => {
