...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-enum-entry-import-not-indexed-silence.md) and
...
test('kotlin-enum-entry-import-not-indexed-silence', async () => {
