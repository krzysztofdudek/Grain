...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-alias-import-name-not-a-target.md) and
...
const FILES = [
  {
    "path": "src/m/Message.kt",
    "language": "kotlin",
    "code": "package org.test\nclass Message\n"
  },
  {
    "path": "src/t/TestMessage.kt",
    "language": "kotlin",
    "code": "package org.test\nclass TestMessage\n"
  },
  {
...
test('kotlin-alias-import-name-not-a-target', async () => {
