...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-supertype-list-edge.md) and
...
const FILES = [
  {
    "path": "src/base/Base.kt",
    "language": "kotlin",
    "code": "package com.acme.base\nopen class Base\n"
  },
  {
    "path": "src/flow/Iface.kt",
    "language": "kotlin",
...
test('kotlin-supertype-list-edge', async () => {
