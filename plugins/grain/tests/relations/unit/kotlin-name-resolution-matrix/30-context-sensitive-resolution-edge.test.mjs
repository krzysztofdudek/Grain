...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-context-sensitive-resolution-edge.md) and
...
const FILES = [
  {
    "path": "src/model/Problem.kt",
    "language": "kotlin",
    "code": "package com.acme.model\nenum class Problem {\n  CONNECTION, AUTHENTICATION\n}\n"
  },
  {
    "path": "src/other/CONNECTION.kt",
    "language": "kotlin",
    "code": "package com.acme.other\nclass CONNECTION\n"
  },
  {
    "path": "src/c/Use.kt",
    "language": "kotlin",
...
test('kotlin-context-sensitive-resolution-edge', async () => {
