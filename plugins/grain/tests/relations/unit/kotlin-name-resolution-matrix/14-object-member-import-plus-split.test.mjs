...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-object-member-import-plus-split.md) and
...
test('kotlin-object-member-import-plus-split', async () => {
