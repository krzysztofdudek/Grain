...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-generic-argument-where-edge.md) and
...
test('kotlin-generic-argument-where-edge', async () => {
