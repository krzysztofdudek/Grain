...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-annotation-use-site-target-edge.md) and
...
test('kotlin-annotation-use-site-target-edge', async () => {
