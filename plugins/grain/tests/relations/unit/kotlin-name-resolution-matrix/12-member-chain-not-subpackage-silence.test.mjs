...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-member-chain-not-subpackage-silence.md) and
...
test('kotlin-member-chain-not-subpackage-silence', async () => {
