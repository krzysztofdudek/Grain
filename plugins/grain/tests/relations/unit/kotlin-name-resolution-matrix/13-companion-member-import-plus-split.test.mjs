...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-companion-member-import-plus-split.md) and
...
test('kotlin-companion-member-import-plus-split', async () => {
