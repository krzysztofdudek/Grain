...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-constructor-call-usage-silence.md) and
...
test('kotlin-constructor-call-usage-silence', async () => {
