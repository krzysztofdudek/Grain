...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-class-literal-callable-ref-usage-silence.md) and
...
test('kotlin-class-literal-callable-ref-usage-silence', async () => {
