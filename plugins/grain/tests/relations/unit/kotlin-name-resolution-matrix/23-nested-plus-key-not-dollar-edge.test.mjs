...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-nested-plus-key-not-dollar-edge.md) and
...
test('kotlin-nested-plus-key-not-dollar-edge', async () => {
