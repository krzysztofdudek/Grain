...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-wildcard-import-package-hint-silence.md) and
...
test('kotlin-wildcard-import-package-hint-silence', async () => {
