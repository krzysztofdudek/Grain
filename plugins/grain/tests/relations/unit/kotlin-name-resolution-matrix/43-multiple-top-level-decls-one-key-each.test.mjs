...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-multiple-top-level-decls-one-key-each.md) and
...
test('kotlin-multiple-top-level-decls-one-key-each', async () => {
