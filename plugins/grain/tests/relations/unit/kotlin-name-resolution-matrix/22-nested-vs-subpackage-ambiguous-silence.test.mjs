...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-nested-vs-subpackage-ambiguous-silence.md) and
...
const FILES = [
  {
    "path": "src/nest/Outer.kt",
    "language": "kotlin",
    "code": "package com.acme\nclass Outer {\n  class Inner\n}\n"
  },
  {
    "path": "src/sub/Inner.kt",
    "language": "kotlin",
    "code": "package com.acme.Outer\nclass Inner\n"
  },
  {
    "path": "src/c/Use.kt",
    "language": "kotlin",
...
test('kotlin-nested-vs-subpackage-ambiguous-silence', async () => {
