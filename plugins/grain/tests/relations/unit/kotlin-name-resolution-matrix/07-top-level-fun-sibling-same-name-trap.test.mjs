...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-top-level-fun-sibling-same-name-trap.md) and
...
test('kotlin-top-level-fun-sibling-same-name-trap', async () => {
