...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-bare-top-level-call-only-import-edge.md) and
...
test('kotlin-bare-top-level-call-only-import-edge', async () => {
