...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-jvmname-no-facade-key-edge.md) and
...
const FILES = [
  {
    "path": "src/o/Orders.kt",
    "language": "kotlin",
    "code": "@file:JvmName(\"OrderUtils\")\npackage com.acme.orders\nclass Order\nfun place() {}\nval DEFAULT = 0\n"
  },
  {
    "path": "src/c/Use.kt",
    "language": "kotlin",
...
test('kotlin-jvmname-no-facade-key-edge', async () => {
