...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-enum-member-import-verbatim-silence.md) and
...
const FILES = [
  {
    "path": "src/c/Use.kt",
    "language": "kotlin",
    "code": "import com.acme.model.Color.RED\nclass C\n"
  }
];
const EXPECT_EDGES = [];
...
test('kotlin-enum-member-import-verbatim-silence', async () => {
