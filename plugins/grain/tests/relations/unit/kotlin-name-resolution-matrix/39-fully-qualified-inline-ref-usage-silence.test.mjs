...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-fully-qualified-inline-ref-usage-silence.md) and
...
test('kotlin-fully-qualified-inline-ref-usage-silence', async () => {
