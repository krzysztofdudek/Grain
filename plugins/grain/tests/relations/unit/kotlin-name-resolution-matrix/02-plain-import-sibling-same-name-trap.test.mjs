...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-plain-import-sibling-same-name-trap.md) and
...
const FILES = [
  {
    "path": "src/pay/Gateway.kt",
    "language": "kotlin",
    "code": "package com.acme.payments\nclass Gateway\n"
  },
  {
    "path": "src/vend/Gateway.kt",
    "language": "kotlin",
...
test('kotlin-plain-import-sibling-same-name-trap', async () => {
