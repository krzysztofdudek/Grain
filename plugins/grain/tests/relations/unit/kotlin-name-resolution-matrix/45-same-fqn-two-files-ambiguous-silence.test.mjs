...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-same-fqn-two-files-ambiguous-silence.md) and
...
test('kotlin-same-fqn-two-files-ambiguous-silence', async () => {
