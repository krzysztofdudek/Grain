...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-explicit-stdlib-import-absent-silence.md) and
...
test('kotlin-explicit-stdlib-import-absent-silence', async () => {
