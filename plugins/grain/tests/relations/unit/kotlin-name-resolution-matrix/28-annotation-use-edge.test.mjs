...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-annotation-use-edge.md) and
...
test('kotlin-annotation-use-edge', async () => {
