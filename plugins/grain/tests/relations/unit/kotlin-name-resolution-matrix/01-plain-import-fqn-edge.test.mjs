...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-plain-import-fqn-edge.md) and
...
const FILES = [
  {
    "path": "src/pay/PaymentService.kt",
    "language": "kotlin",
...
test('kotlin-plain-import-fqn-edge', async () => {
