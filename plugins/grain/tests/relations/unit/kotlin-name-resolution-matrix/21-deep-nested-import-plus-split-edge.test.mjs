...
// and `## Expect` edges (from Yggdrasil reference/relations/kotlin/kotlin-deep-nested-import-plus-split-edge.md) and
...
test('kotlin-deep-nested-import-plus-split-edge', async () => {
