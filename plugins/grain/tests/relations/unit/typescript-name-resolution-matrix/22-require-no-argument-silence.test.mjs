...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-require-no-argument-silence',
// backed by reference/relations/typescript/typescript-require-no-argument-silence.md. This file inlines the
...
test('typescript-require-no-argument-silence', async () => {
  const files = [
  { path: "r/app/use.ts", language: "typescript", code: "const x = require();\nconst y = require(dynamicVar);\n" },
  ];
