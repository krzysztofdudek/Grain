...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-nodenext-js-to-ts-edge',
// backed by reference/relations/typescript/typescript-nodenext-js-to-ts-edge.md. This file inlines the
...
test('typescript-nodenext-js-to-ts-edge', async () => {
  const files = [
  { path: "r/esm/mod.ts", language: "typescript", code: "export const a = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import { a } from '../esm/mod.js';\nconsole.log(a);\n" },
  ];
  const materializeOnlyFiles = [

  ];
  const expectEdges = [
  { fromFile: "r/app/use.ts", line: 1, node: "esm" },
  ];
