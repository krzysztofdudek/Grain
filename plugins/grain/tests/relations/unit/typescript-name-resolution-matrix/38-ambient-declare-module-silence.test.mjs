...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-ambient-declare-module-silence',
// backed by reference/relations/typescript/typescript-ambient-declare-module-silence.md. This file inlines the
...
test('typescript-ambient-declare-module-silence', async () => {
  const files = [
  { path: "r/foo/value.ts", language: "typescript", code: "export const x = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "declare module 'foo' {\n  export const x: number;\n}\ndeclare module '*.css' {\n  const url: string;\n  export default url;\n}\n" },
  ];
