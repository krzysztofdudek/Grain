...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-sibling-same-name-trap-edge',
// backed by reference/relations/typescript/typescript-sibling-same-name-trap-edge.md. This file inlines the
...
test('typescript-sibling-same-name-trap-edge', async () => {
  const files = [
  { path: "r/m/value.ts", language: "typescript", code: "export const X = 1;\n" },
  { path: "r/other/value.ts", language: "typescript", code: "export const X = 2;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import { X } from '../m/value';\nconsole.log(X);\n" },
  ];
