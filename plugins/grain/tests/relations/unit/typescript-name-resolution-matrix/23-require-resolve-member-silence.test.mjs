...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-require-resolve-member-silence',
// backed by reference/relations/typescript/typescript-require-resolve-member-silence.md. This file inlines the
...
test('typescript-require-resolve-member-silence', async () => {
  const files = [
  { path: "r/m/value.ts", language: "typescript", code: "export const a = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "const p = require.resolve('../m/value');\nconsole.log(p);\n" },
  ];
