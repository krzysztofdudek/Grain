...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-named-reexport-edge',
// backed by reference/relations/typescript/typescript-named-reexport-edge.md. This file inlines the
...
test('typescript-named-reexport-edge', async () => {
  const files = [
  { path: "r/x/value.ts", language: "typescript", code: "export const X = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "export { X } from '../x/value';\n" },
  ];
  const materializeOnlyFiles = [

  ];
  const expectEdges = [
  { fromFile: "r/app/use.ts", line: 1, node: "x" },
  ];
