...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-import-meta-resolve-silence',
// backed by reference/relations/typescript/typescript-import-meta-resolve-silence.md. This file inlines the
...
test('typescript-import-meta-resolve-silence', async () => {
  const files = [
  { path: "r/m/value.ts", language: "typescript", code: "export const a = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "const u = import.meta.resolve('../m/value');\nconsole.log(u);\n" },
  ];
