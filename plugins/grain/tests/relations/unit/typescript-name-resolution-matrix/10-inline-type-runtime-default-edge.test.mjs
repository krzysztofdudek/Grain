...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-inline-type-runtime-default-edge',
// backed by reference/relations/typescript/typescript-inline-type-runtime-default-edge.md. This file inlines the
...
test('typescript-inline-type-runtime-default-edge', async () => {
  const files = [
  { path: "r/m/value.ts", language: "typescript", code: "export default function def() {}\nexport interface A {}\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import def, { type A } from '../m/value';\ndef();\nconst a: A = {} as A;\n" },
  ];
