...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-dynamic-import-literal-edge',
// backed by reference/relations/typescript/typescript-dynamic-import-literal-edge.md. This file inlines the
...
test('typescript-dynamic-import-literal-edge', async () => {
  const files = [
  { path: "r/d/value.ts", language: "typescript", code: "export const a = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "const d = import('../d/value');\n" },
  ];
  const materializeOnlyFiles = [

  ];
  const expectEdges = [
  { fromFile: "r/app/use.ts", line: 1, node: "d" },
  ];
