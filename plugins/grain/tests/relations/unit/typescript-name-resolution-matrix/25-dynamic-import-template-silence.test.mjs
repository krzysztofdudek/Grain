...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-dynamic-import-template-silence',
// backed by reference/relations/typescript/typescript-dynamic-import-template-silence.md. This file inlines the
...
test('typescript-dynamic-import-template-silence', async () => {
  const files = [
  { path: "r/x-a/value.ts", language: "typescript", code: "export const a = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "const d = import(`../x-${v}/value`);\n" },
  ];
