...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-namespace-import-edge',
// backed by reference/relations/typescript/typescript-namespace-import-edge.md. This file inlines the
...
test('typescript-namespace-import-edge', async () => {
  const files = [
  { path: "r/m/value.ts", language: "typescript", code: "export const a = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import * as ns from '../m/value';\nconsole.log(ns.a);\n" },
  ];
