...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-require-edge',
// backed by reference/relations/typescript/typescript-require-edge.md. This file inlines the
...
test('typescript-require-edge', async () => {
  const files = [
  { path: "r/m/value.ts", language: "typescript", code: "module.exports = { go() {} };\n" },
  { path: "r/app/use.ts", language: "typescript", code: "const a = require('../m/value');\na.go();\n" },
  ];
