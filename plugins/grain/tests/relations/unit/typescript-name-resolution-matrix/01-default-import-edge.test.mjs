...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-default-import-edge',
// backed by reference/relations/typescript/typescript-default-import-edge.md. This file inlines the
...
test('typescript-default-import-edge', async () => {
  const files = [
  { path: "r/m/value.ts", language: "typescript", code: "export default function helloWorld() {}\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import helloWorld from '../m/value';\nhelloWorld();\n" },
  ];
