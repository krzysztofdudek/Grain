...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-tsconfig-alias-silence',
// backed by reference/relations/typescript/typescript-tsconfig-alias-silence.md. This file inlines the
...
test('typescript-tsconfig-alias-silence', async () => {
  const files = [
  { path: "r/app-x/value.ts", language: "typescript", code: "export const X = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import { X } from '@app/x';\nconsole.log(X);\n" },
  ];
