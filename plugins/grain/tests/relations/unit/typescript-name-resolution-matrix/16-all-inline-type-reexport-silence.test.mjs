...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-all-inline-type-reexport-silence',
// backed by reference/relations/typescript/typescript-all-inline-type-reexport-silence.md. This file inlines the
...
test('typescript-all-inline-type-reexport-silence', async () => {
  const files = [
  { path: "r/t/types.ts", language: "typescript", code: "export interface A {}\nexport interface B {}\n" },
  { path: "r/app/use.ts", language: "typescript", code: "export { type A, type B } from '../t/types';\n" },
  ];
