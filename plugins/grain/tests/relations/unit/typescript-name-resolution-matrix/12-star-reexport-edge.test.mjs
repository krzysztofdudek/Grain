...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-star-reexport-edge',
// backed by reference/relations/typescript/typescript-star-reexport-edge.md. This file inlines the
...
test('typescript-star-reexport-edge', async () => {
  const files = [
  { path: "r/x/value.ts", language: "typescript", code: "export const a = 1;\nexport const b = 2;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "export * from '../x/value';\n" },
  ];
