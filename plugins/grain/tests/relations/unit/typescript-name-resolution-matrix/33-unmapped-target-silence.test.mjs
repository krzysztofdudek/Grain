...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-unmapped-target-silence',
// backed by reference/relations/typescript/typescript-unmapped-target-silence.md. This file inlines the
...
test('typescript-unmapped-target-silence', async () => {
  const files = [
  { path: "r/app/use.ts", language: "typescript", code: "import { x } from '../nope/missing';\nconsole.log(x);\n" },
  ];
