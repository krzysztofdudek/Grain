...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-intra-node-import-silence',
// backed by reference/relations/typescript/typescript-intra-node-import-silence.md. This file inlines the
...
test('typescript-intra-node-import-silence', async () => {
  const files = [
  { path: "r/app/sibling.ts", language: "typescript", code: "export const a = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import { a } from './sibling';\nconsole.log(a);\n" },
  ];
