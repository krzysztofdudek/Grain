...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-import-equals-require-edge',
// backed by reference/relations/typescript/typescript-import-equals-require-edge.md. This file inlines the
...
test('typescript-import-equals-require-edge', async () => {
  const files = [
  { path: "r/m/value.ts", language: "typescript", code: "export = { go() {} };\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import b = require('../m/value');\nb.go();\n" },
  ];
