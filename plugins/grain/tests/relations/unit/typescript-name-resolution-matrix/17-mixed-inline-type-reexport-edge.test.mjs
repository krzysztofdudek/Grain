...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-mixed-inline-type-reexport-edge',
// backed by reference/relations/typescript/typescript-mixed-inline-type-reexport-edge.md. This file inlines the
...
test('typescript-mixed-inline-type-reexport-edge', async () => {
  const files = [
  { path: "r/m/value.ts", language: "typescript", code: "export interface A {}\nexport const b = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "export { type A, b } from '../m/value';\n" },
  ];
