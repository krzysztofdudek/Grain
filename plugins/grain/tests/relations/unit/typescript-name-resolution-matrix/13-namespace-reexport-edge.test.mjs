...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-namespace-reexport-edge',
// backed by reference/relations/typescript/typescript-namespace-reexport-edge.md. This file inlines the
...
test('typescript-namespace-reexport-edge', async () => {
  const files = [
  { path: "r/ns/value.ts", language: "typescript", code: "export const a = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "export * as ns from '../ns/value';\n" },
  ];
  const materializeOnlyFiles = [

  ];
  const expectEdges = [
  { fromFile: "r/app/use.ts", line: 1, node: "ns" },
  ];
