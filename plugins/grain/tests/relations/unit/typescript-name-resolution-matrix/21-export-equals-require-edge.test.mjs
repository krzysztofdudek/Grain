...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-export-equals-require-edge',
// backed by reference/relations/typescript/typescript-export-equals-require-edge.md. This file inlines the
...
test('typescript-export-equals-require-edge', async () => {
  const files = [
  { path: "r/e/value.ts", language: "typescript", code: "module.exports = { go() {} };\n" },
  { path: "r/app/use.ts", language: "typescript", code: "export = require('../e/value');\n" },
  ];
  const materializeOnlyFiles = [

  ];
  const expectEdges = [
  { fromFile: "r/app/use.ts", line: 1, node: "e" },
  ];
