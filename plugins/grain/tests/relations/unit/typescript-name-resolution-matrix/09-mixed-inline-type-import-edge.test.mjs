...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-mixed-inline-type-import-edge',
// backed by reference/relations/typescript/typescript-mixed-inline-type-import-edge.md. This file inlines the
...
test('typescript-mixed-inline-type-import-edge', async () => {
  const files = [
  { path: "r/m/value.ts", language: "typescript", code: "export interface A {}\nexport const b = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import { type A, b } from '../m/value';\nconst a: A = {} as A;\nconsole.log(b);\n" },
  ];
