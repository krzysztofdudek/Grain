...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-relative-resolves-tsx-edge',
// backed by reference/relations/typescript/typescript-relative-resolves-tsx-edge.md. This file inlines the
...
test('typescript-relative-resolves-tsx-edge', async () => {
  const files = [
  { path: "r/widget/Widget.tsx", language: "tsx", code: "export const Widget = () => null;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import { Widget } from '../widget/Widget';\nconst w = Widget;\n" },
  ];
  const materializeOnlyFiles = [

  ];
  const expectEdges = [
  { fromFile: "r/app/use.ts", line: 1, node: "widget" },
  ];
