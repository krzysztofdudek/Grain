...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-directory-index-edge',
// backed by reference/relations/typescript/typescript-directory-index-edge.md. This file inlines the
...
test('typescript-directory-index-edge', async () => {
  const files = [
  { path: "r/pkg/index.ts", language: "typescript", code: "export const a = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import { a } from '../pkg';\nconsole.log(a);\n" },
  ];
  const materializeOnlyFiles = [

  ];
  const expectEdges = [
  { fromFile: "r/app/use.ts", line: 1, node: "pkg" },
  ];
