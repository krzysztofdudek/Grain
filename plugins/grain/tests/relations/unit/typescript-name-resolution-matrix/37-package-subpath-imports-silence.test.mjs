...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-package-subpath-imports-silence',
// backed by reference/relations/typescript/typescript-package-subpath-imports-silence.md. This file inlines the
...
test('typescript-package-subpath-imports-silence', async () => {
  const files = [
  { path: "r/internal/x.ts", language: "typescript", code: "export const x = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import { x } from '#internal/x';\nconsole.log(x);\n" },
  ];
