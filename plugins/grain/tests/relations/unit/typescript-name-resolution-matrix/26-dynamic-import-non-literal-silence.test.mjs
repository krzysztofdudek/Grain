...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-dynamic-import-non-literal-silence',
// backed by reference/relations/typescript/typescript-dynamic-import-non-literal-silence.md. This file inlines the
...
test('typescript-dynamic-import-non-literal-silence', async () => {
  const files = [
  { path: "r/a/value.ts", language: "typescript", code: "export const a = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "const d1 = import(v);\nconst d2 = import('../a/value' + v);\nconst d3 = import('');\n" },
  ];
