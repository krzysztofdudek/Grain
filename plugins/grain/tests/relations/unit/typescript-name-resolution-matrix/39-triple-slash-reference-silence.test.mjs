...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-triple-slash-reference-silence',
// backed by reference/relations/typescript/typescript-triple-slash-reference-silence.md. This file inlines the
...
test('typescript-triple-slash-reference-silence', async () => {
  const files = [
  { path: "r/globals/types.ts", language: "typescript", code: "export const g = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "/// <reference path=\"../globals/types.ts\" />\n/// <reference types=\"node\" />\nconst x = 1;\n" },
  ];
