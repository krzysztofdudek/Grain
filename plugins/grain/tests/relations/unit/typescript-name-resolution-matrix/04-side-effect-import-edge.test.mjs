...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-side-effect-import-edge',
// backed by reference/relations/typescript/typescript-side-effect-import-edge.md. This file inlines the
...
test('typescript-side-effect-import-edge', async () => {
  const files = [
  { path: "r/m/polyfill.ts", language: "typescript", code: "globalThis.installed = true;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import '../m/polyfill';\n" },
  ];
