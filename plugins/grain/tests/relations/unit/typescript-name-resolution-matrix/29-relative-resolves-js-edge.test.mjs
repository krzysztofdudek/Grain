...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-relative-resolves-js-edge',
// backed by reference/relations/typescript/typescript-relative-resolves-js-edge.md. This file inlines the
...
test('typescript-relative-resolves-js-edge', async () => {
  const files = [
  { path: "r/legacy/mod.js", language: "javascript", code: "exports.go = function () {};\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import { go } from '../legacy/mod';\ngo();\n" },
  ];
  const materializeOnlyFiles = [

  ];
  const expectEdges = [
  { fromFile: "r/app/use.ts", line: 1, node: "legacy" },
  ];
