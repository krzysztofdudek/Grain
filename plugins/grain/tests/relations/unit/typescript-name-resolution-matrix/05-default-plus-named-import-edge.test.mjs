...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-default-plus-named-import-edge',
// backed by reference/relations/typescript/typescript-default-plus-named-import-edge.md. This file inlines the
...
test('typescript-default-plus-named-import-edge', async () => {
  const files = [
  { path: "r/m/value.ts", language: "typescript", code: "export default function def() {}\nexport const a = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import def, { a } from '../m/value';\ndef();\nconsole.log(a);\n" },
  ];
