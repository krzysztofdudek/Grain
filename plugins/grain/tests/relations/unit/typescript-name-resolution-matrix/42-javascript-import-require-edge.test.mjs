...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-javascript-import-require-edge',
// backed by reference/relations/typescript/typescript-javascript-import-require-edge.md. This file inlines the
...
test('typescript-javascript-import-require-edge', async () => {
  const files = [
  { path: "r/m/value.ts", language: "typescript", code: "export default function x() {}\n" },
  { path: "r/n/value.ts", language: "typescript", code: "module.exports = { go() {} };\n" },
  { path: "r/app/use.js", language: "javascript", code: "import x from '../m/value';\nconst y = require('../n/value');\nx();\ny.go();\n" },
  ];
  const materializeOnlyFiles = [

  ];
  const expectEdges = [
  { fromFile: "r/app/use.js", line: 1, node: "m" },
  { fromFile: "r/app/use.js", line: 2, node: "n" },
  ];
