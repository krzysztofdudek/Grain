...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-usage-site-no-import-silence',
// backed by reference/relations/typescript/typescript-usage-site-no-import-silence.md. This file inlines the
...
test('typescript-usage-site-no-import-silence', async () => {
  const files = [
  { path: "r/base/Parent.ts", language: "typescript", code: "export class Parent {}\n" },
  { path: "r/app/Child.ts", language: "typescript", code: "declare const Parent: { new (): unknown };\nclass Child extends Parent {}\nconst c = new Child();\n" },
  ];
