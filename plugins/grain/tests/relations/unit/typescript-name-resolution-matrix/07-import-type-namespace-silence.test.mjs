...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-import-type-namespace-silence',
// backed by reference/relations/typescript/typescript-import-type-namespace-silence.md. This file inlines the
...
test('typescript-import-type-namespace-silence', async () => {
  const files = [
