...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-all-inline-type-reexport-edge',
// backed by reference/relations/typescript/typescript-all-inline-type-reexport-edge.md. This file inlines the
...
test('typescript-all-inline-type-reexport-edge', async () => {
  const files = [
