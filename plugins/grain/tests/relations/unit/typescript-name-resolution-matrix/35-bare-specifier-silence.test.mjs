...
// Ported from Yggdrasil's typescript-name-resolution-matrix.test.ts case 'typescript-bare-specifier-silence',
// backed by reference/relations/typescript/typescript-bare-specifier-silence.md. This file inlines the
...
test('typescript-bare-specifier-silence', async () => {
  const files = [
  { path: "r/lodash/value.ts", language: "typescript", code: "export const x = 1;\n" },
  { path: "r/app/use.ts", language: "typescript", code: "import x from 'lodash';\nimport path from 'node:path';\nconsole.log(x, path);\n" },
  ];
