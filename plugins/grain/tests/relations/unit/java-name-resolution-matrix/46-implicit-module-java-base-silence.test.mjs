...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-implicit-module-java-base-silence')`, which drives the
// catalogue doc reference/relations/java/java-implicit-module-java-base-silence.md end-to-end through the real extractor +
...
test('java-implicit-module-java-base-silence', async () => {
