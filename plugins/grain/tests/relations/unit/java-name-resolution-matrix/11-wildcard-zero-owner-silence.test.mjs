...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-wildcard-zero-owner-silence')`, which drives the
// catalogue doc reference/relations/java/java-wildcard-zero-owner-silence.md end-to-end through the real extractor +
...
test('java-wildcard-zero-owner-silence', async () => {
