...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-enum-case-label-silence')`, which drives the
// catalogue doc reference/relations/java/java-enum-case-label-silence.md end-to-end through the real extractor +
...
test('java-enum-case-label-silence', async () => {
