...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-instanceof-cast-classliteral-edge')`, which drives the
// catalogue doc reference/relations/java/java-instanceof-cast-classliteral-edge.md end-to-end through the real extractor +
...
const FILES = [
  ...
  {
    "path": "src/main/java/com/acme/model/Bar.java",
    "code": "package com.acme.model;\npublic class Bar {}\n"
  },
  {
    "path": "src/main/java/com/acme/model/Baz.java",
    "code": "package com.acme.model;\npublic class Baz {}\n"
  },
  {
...
const EXPECT_EDGES = [
  "src/main/java/com/app/C.java:4->model",
  "src/main/java/com/app/C.java:5->model",
  "src/main/java/com/app/C.java:6->model"
];

test('java-instanceof-cast-classliteral-edge', async () => {
