...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-jdk-import-silence')`, which drives the
// catalogue doc reference/relations/java/java-jdk-import-silence.md end-to-end through the real extractor +
...
test('java-jdk-import-silence', async () => {
