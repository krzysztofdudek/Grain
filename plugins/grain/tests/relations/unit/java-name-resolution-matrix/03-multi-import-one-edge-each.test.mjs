...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-multi-import-one-edge-each')`, which drives the
// catalogue doc reference/relations/java/java-multi-import-one-edge-each.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/acme/a/Alpha.java",
    "code": "package com.acme.a;\npublic class Alpha {}\n"
  },
  {
    "path": "src/main/java/com/acme/b/Beta.java",
    "code": "package com.acme.b;\npublic class Beta {}\n"
  },
  {
...
const EXPECT_EDGES = [
  "src/main/java/com/app/Use.java:2->a",
  "src/main/java/com/app/Use.java:3->b"
];

test('java-multi-import-one-edge-each', async () => {
