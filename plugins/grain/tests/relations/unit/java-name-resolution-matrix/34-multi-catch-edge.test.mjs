...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-multi-catch-edge')`, which drives the
// catalogue doc reference/relations/java/java-multi-catch-edge.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/acme/err/E1.java",
    "code": "package com.acme.err;\npublic class E1 extends Exception {}\n"
  },
  {
    "path": "src/main/java/com/acme/err/E2.java",
...
const EXPECT_EDGES = [
  "src/main/java/com/app/C.java:4->err"
];

test('java-multi-catch-edge', async () => {
