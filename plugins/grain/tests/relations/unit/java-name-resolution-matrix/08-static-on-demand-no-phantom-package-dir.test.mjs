...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-static-on-demand-no-phantom-package-dir')`, which drives the
// catalogue doc reference/relations/java/java-static-on-demand-no-phantom-package-dir.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/acme/util/Constants/A.java",
    "code": "package com.acme.util.Constants;\npublic class A {}\n"
  },
  {
    "path": "src/main/java/com/acme/util/Constants/B.java",
    "code": "package com.acme.util.Constants;\npublic class B {}\n"
  },
  {
...
test('java-static-on-demand-no-phantom-package-dir', async () => {
