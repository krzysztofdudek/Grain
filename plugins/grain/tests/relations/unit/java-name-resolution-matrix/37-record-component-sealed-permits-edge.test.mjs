...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-record-component-sealed-permits-edge')`, which drives the
// catalogue doc reference/relations/java/java-record-component-sealed-permits-edge.md end-to-end through the real extractor +
...
const FILES = [
  ...
  {
    "path": "src/main/java/com/acme/model/Sub.java",
    "code": "package com.acme.model;\npublic final class Sub {}\n"
  },
  {
    "path": "src/main/java/com/app/Decls.java",
    "code": "package com.app;\nrecord R(com.acme.model.Foo f) {}\nsealed interface S permits com.acme.model.Sub {}\n"
  }
];

const EXPECT_EDGES = [
  "src/main/java/com/app/Decls.java:2->model",
  "src/main/java/com/app/Decls.java:3->model"
];

test('java-record-component-sealed-permits-edge', async () => {
