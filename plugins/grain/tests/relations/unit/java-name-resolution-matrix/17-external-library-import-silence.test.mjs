...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-external-library-import-silence')`, which drives the
// catalogue doc reference/relations/java/java-external-library-import-silence.md end-to-end through the real extractor +
...
test('java-external-library-import-silence', async () => {
