...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-bare-autoimport-usage-silence')`, which drives the
// catalogue doc reference/relations/java/java-bare-autoimport-usage-silence.md end-to-end through the real extractor +
...
test('java-bare-autoimport-usage-silence', async () => {
