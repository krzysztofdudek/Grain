...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-unnamed-underscore-not-ref')`, which drives the
// catalogue doc reference/relations/java/java-unnamed-underscore-not-ref.md end-to-end through the real extractor +
...
test('java-unnamed-underscore-not-ref', async () => {
