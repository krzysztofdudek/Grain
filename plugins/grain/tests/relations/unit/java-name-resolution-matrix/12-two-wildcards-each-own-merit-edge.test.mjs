...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-two-wildcards-each-own-merit-edge')`, which drives the
// catalogue doc reference/relations/java/java-two-wildcards-each-own-merit-edge.md end-to-end through the real extractor +
...
const FILES = [
  ...
  {
    "path": "src/main/java/com/y/Foo.java",
    "code": "package com.y;\npublic class Foo {}\n"
  },
  {
...
const EXPECT_EDGES = [
  "src/main/java/com/app/Use.java:2->x",
  "src/main/java/com/app/Use.java:3->y"
];

test('java-two-wildcards-each-own-merit-edge', async () => {
