...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-deep-nested-import-one-level-limit-silence')`, which drives the
// catalogue doc reference/relations/java/java-deep-nested-import-one-level-limit-silence.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/acme/Outer.java",
...
test('java-deep-nested-import-one-level-limit-silence', async () => {
