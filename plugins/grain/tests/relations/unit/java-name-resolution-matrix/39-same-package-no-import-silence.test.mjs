...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-same-package-no-import-silence')`, which drives the
// catalogue doc reference/relations/java/java-same-package-no-import-silence.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/a/Parent.java",
    "code": "package com.a;\npublic class Parent {}\n"
  },
  {
    "path": "src/main/java/com/a/Sibling.java",
    "code": "package com.a;\npublic class Sibling {}\n"
  },
  {
    "path": "src/main/java/com/a/Child.java",
...
test('java-same-package-no-import-silence', async () => {
