...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-enum-constant-use-usage-silence')`, which drives the
// catalogue doc reference/relations/java/java-enum-constant-use-usage-silence.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/acme/model/Color.java",
...
test('java-enum-constant-use-usage-silence', async () => {
