...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-throws-clause-edge')`, which drives the
// catalogue doc reference/relations/java/java-throws-clause-edge.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/acme/err/Boom.java",
...
const EXPECT_EDGES = [
  "src/main/java/com/app/C.java:3->err"
];

test('java-throws-clause-edge', async () => {
