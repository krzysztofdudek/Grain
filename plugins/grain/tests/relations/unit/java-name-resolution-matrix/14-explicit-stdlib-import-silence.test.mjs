...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-explicit-stdlib-import-silence')`, which drives the
// catalogue doc reference/relations/java/java-explicit-stdlib-import-silence.md end-to-end through the real extractor +
...
test('java-explicit-stdlib-import-silence', async () => {
