...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-fully-qualified-expression-call-silence')`, which drives the
// catalogue doc reference/relations/java/java-fully-qualified-expression-call-silence.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/b/Util.java",
    "code": "package com.b;\npublic class Util {\n  public static void run() {}\n}\n"
  },
  {
    "path": "src/main/java/com/a/X.java",
    "code": "package com.a;\nclass X {\n  void m() {\n    com.b.Util.run();\n  }\n}\n"
  }
];
...
test('java-fully-qualified-expression-call-silence', async () => {
