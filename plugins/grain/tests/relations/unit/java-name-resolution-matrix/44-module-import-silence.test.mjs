...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-module-import-silence')`, which drives the
// catalogue doc reference/relations/java/java-module-import-silence.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/acme/lib/X.java",
    "code": "package com.acme.lib;\npublic class X {}\n"
  },
  {
...
test('java-module-import-silence', async () => {
