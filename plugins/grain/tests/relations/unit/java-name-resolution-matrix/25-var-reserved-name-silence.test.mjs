...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-var-reserved-name-silence')`, which drives the
// catalogue doc reference/relations/java/java-var-reserved-name-silence.md end-to-end through the real extractor +
...
test('java-var-reserved-name-silence', async () => {
