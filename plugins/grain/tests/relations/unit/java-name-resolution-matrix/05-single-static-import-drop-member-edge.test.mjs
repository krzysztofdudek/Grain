...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-single-static-import-drop-member-edge')`, which drives the
// catalogue doc reference/relations/java/java-single-static-import-drop-member-edge.md end-to-end through the real extractor +
...
test('java-single-static-import-drop-member-edge', async () => {
