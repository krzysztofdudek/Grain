...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-qualified-inline-outer-import-only-edge')`, which drives the
// catalogue doc reference/relations/java/java-qualified-inline-outer-import-only-edge.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/foo/Outer.java",
...
const EXPECT_EDGES = [
  "src/main/java/com/app/Use.java:2->foo"
];

test('java-qualified-inline-outer-import-only-edge', async () => {
