...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-array-varargs-element-edge')`, which drives the
// catalogue doc reference/relations/java/java-array-varargs-element-edge.md end-to-end through the real extractor +
...
test('java-array-varargs-element-edge', async () => {
