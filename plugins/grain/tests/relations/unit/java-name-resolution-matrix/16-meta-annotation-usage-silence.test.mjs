...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-meta-annotation-usage-silence')`, which drives the
// catalogue doc reference/relations/java/java-meta-annotation-usage-silence.md end-to-end through the real extractor +
...
test('java-meta-annotation-usage-silence', async () => {
