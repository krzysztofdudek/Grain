...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-partially-qualified-inline-silence')`, which drives the
// catalogue doc reference/relations/java/java-partially-qualified-inline-silence.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/a/Outer.java",
...
test('java-partially-qualified-inline-silence', async () => {
