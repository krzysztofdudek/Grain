...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-primitive-class-literal-silence')`, which drives the
// catalogue doc reference/relations/java/java-primitive-class-literal-silence.md end-to-end through the real extractor +
...
test('java-primitive-class-literal-silence', async () => {
