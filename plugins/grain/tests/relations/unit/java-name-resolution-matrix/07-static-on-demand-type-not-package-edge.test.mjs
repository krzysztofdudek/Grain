...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-static-on-demand-type-not-package-edge')`, which drives the
// catalogue doc reference/relations/java/java-static-on-demand-type-not-package-edge.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/acme/util/Constants.java",
...
test('java-static-on-demand-type-not-package-edge', async () => {
