...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-single-import-sibling-same-name-trap')`, which drives the
// catalogue doc reference/relations/java/java-single-import-sibling-same-name-trap.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/acme/payments/Gateway.java",
    "code": "package com.acme.payments;\npublic class Gateway {}\n"
  },
  {
    "path": "src/main/java/com/vendor/Gateway.java",
    "code": "package com.vendor;\npublic class Gateway {}\n"
  },
  {
...
test('java-single-import-sibling-same-name-trap', async () => {
