...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-annotation-use-usage-silence')`, which drives the
// catalogue doc reference/relations/java/java-annotation-use-usage-silence.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/acme/audit/Audit.java",
...
test('java-annotation-use-usage-silence', async () => {
