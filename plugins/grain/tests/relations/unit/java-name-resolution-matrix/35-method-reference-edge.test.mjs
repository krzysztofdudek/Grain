...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-method-reference-edge')`, which drives the
// catalogue doc reference/relations/java/java-method-reference-edge.md end-to-end through the real extractor +
...
test('java-method-reference-edge', async () => {
