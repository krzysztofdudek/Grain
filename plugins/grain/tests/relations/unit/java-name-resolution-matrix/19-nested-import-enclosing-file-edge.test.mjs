...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-nested-import-enclosing-file-edge')`, which drives the
// catalogue doc reference/relations/java/java-nested-import-enclosing-file-edge.md end-to-end through the real extractor +
...
test('java-nested-import-enclosing-file-edge', async () => {
