...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-no-import-alias')`, which drives the
// catalogue doc reference/relations/java/java-no-import-alias.md end-to-end through the real extractor +
...
test('java-no-import-alias', async () => {
