...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-extends-implements-edge')`, which drives the
// catalogue doc reference/relations/java/java-extends-implements-edge.md end-to-end through the real extractor +
...
const FILES = [
  ...
  {
    "path": "src/main/java/com/acme/flow/Flowable.java",
...
const EXPECT_EDGES = [
  "src/main/java/com/app/C.java:2->base",
  "src/main/java/com/app/C.java:2->flow"
];

test('java-extends-implements-edge', async () => {
