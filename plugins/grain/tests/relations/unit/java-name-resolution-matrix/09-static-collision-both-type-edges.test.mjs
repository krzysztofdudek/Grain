...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-static-collision-both-type-edges')`, which drives the
// catalogue doc reference/relations/java/java-static-collision-both-type-edges.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/util/maths/Maths.java",
    "code": "package com.util.maths;\npublic class Maths {\n  public static int max(int a, int b) { return a > b ? a : b; }\n}\n"
  },
  {
    "path": "src/main/java/com/util/limits/Limits.java",
    "code": "package com.util.limits;\npublic class Limits {\n  public static int max() { return 100; }\n}\n"
  },
  {
...
const EXPECT_EDGES = [
  "src/main/java/com/app/Use.java:2->maths",
  "src/main/java/com/app/Use.java:3->limits"
];

test('java-static-collision-both-type-edges', async () => {
