...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-wildcard-one-owner-edge')`, which drives the
// catalogue doc reference/relations/java/java-wildcard-one-owner-edge.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/acme/audit/AuditLog.java",
    "code": "package com.acme.audit;\npublic class AuditLog {}\n"
  },
  {
    "path": "src/main/java/com/acme/audit/AuditWriter.java",
...
const EXPECT_EDGES = [
  "src/main/java/com/app/Use.java:2->audit"
];

test('java-wildcard-one-owner-edge', async () => {
