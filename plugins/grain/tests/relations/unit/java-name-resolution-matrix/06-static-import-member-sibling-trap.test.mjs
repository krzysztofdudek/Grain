...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-static-import-member-sibling-trap')`, which drives the
// catalogue doc reference/relations/java/java-static-import-member-sibling-trap.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/acme/util/Helpers.java",
    "code": "package com.acme.util;\npublic class Helpers {\n  public static String format(Object o) { return String.valueOf(o); }\n}\n"
  },
  {
    "path": "src/main/java/com/acme/util/Helpers/format.java",
    "code": "package com.acme.util.Helpers;\npublic class format {}\n"
  },
  {
...
const EXPECT_EDGES = [
  "src/main/java/com/app/Use.java:2->util"
];

test('java-static-import-member-sibling-trap', async () => {
