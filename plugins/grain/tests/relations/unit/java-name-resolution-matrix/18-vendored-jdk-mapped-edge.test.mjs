...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-vendored-jdk-mapped-edge')`, which drives the
// catalogue doc reference/relations/java/java-vendored-jdk-mapped-edge.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/java/lang/String.java",
...
const EXPECT_EDGES = [
  "src/main/java/com/app/Use.java:2->lang"
];

test('java-vendored-jdk-mapped-edge', async () => {
