...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-generic-method-witness-edge')`, which drives the
// catalogue doc reference/relations/java/java-generic-method-witness-edge.md end-to-end through the real extractor +
...
test('java-generic-method-witness-edge', async () => {
