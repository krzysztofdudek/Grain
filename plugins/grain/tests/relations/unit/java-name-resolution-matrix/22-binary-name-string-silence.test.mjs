...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-binary-name-string-silence')`, which drives the
// catalogue doc reference/relations/java/java-binary-name-string-silence.md end-to-end through the real extractor +
...
test('java-binary-name-string-silence', async () => {
