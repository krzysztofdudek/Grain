...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-new-anonymous-diamond-edge')`, which drives the
// catalogue doc reference/relations/java/java-new-anonymous-diamond-edge.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/acme/metrics/Timer.java",
    "code": "package com.acme.metrics;\npublic class Timer {}\n"
  },
  {
    "path": "src/main/java/com/acme/base/Base.java",
    "code": "package com.acme.base;\npublic class Base {}\n"
  },
  {
    "path": "src/main/java/com/acme/model/Foo.java",
...
const EXPECT_EDGES = [
  "src/main/java/com/app/C.java:4->metrics",
  "src/main/java/com/app/C.java:5->base",
  "src/main/java/com/app/C.java:6->model"
];

test('java-new-anonymous-diamond-edge', async () => {
