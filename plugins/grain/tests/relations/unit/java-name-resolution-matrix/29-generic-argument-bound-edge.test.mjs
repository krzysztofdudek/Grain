...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-generic-argument-bound-edge')`, which drives the
// catalogue doc reference/relations/java/java-generic-argument-bound-edge.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/acme/model/Base.java",
    "code": "package com.acme.model;\npublic class Base {}\n"
  },
  {
    "path": "src/main/java/com/acme/flow/Iface.java",
    "code": "package com.acme.flow;\npublic interface Iface {}\n"
  },
  {
...
const EXPECT_EDGES = [
  "src/main/java/com/app/C.java:2->flow",
  "src/main/java/com/app/C.java:2->model",
  "src/main/java/com/app/C.java:3->model",
  "src/main/java/com/app/C.java:4->flow"
];

test('java-generic-argument-bound-edge', async () => {
