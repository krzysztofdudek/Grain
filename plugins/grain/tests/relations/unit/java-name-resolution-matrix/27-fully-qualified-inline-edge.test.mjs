...
// Ported from Yggdrasil's reference-case-runner.ts `runCase('java-fully-qualified-inline-edge')`, which drives the
// catalogue doc reference/relations/java/java-fully-qualified-inline-edge.md end-to-end through the real extractor +
...
const FILES = [
  {
    "path": "src/main/java/com/b/Bar.java",
    "code": "package com.b;\npublic class Bar {}\n"
  },
  {
...
const EXPECT_EDGES = [
  "src/main/java/com/a/X.java:3->b"
];

test('java-fully-qualified-inline-edge', async () => {
