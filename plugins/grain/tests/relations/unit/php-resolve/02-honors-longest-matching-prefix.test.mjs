...
test('honors the longest matching prefix (App\\Tests\\ over App\\)', () => {
  expect(phpResolve.resolvePhpFqn('App\\Tests\\Unit\\GatewayTest', FROM, deps)).toBe('tests/Unit/GatewayTest.php');
});
