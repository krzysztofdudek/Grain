...
const CASE_FILES = [
  { path: "src/app/billing/__init__.py", language: 'python', code: "pass\n" },
  { path: "src/app/billing/charge.py", language: 'python', code: "def charge():\n    pass\n" },
  { path: "src/app/sub/handler.py", language: 'python', code: "from ..billing import charge\n\ncharge.charge()\n" },
];
const EXPECT_EDGES = [
  { fromFile: "src/app/sub/handler.py", line: 1, node: "billing" },
];
const EXPECT_SILENCE = false;

test("python-relative-parent-import-edge", async () => {
