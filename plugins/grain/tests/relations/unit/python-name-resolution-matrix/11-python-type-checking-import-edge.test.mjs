...
const CASE_FILES = [
  { path: "src/billing/charge.py", language: 'python', code: "class Charge:\n    pass\n" },
  { path: "src/app/main.py", language: 'python', code: "from typing import TYPE_CHECKING\n\nif TYPE_CHECKING:\n    from billing.charge import Charge\n" },
];
const EXPECT_EDGES = [
  { fromFile: "src/app/main.py", line: 4, node: "billing" },
];
const EXPECT_SILENCE = false;

test("python-type-checking-import-edge", async () => {
