...
const CASE_FILES = [
  { path: "src/billing/__init__.py", language: 'python', code: "pass\n" },
  { path: "src/billing/charge.py", language: 'python', code: "def charge():\n    pass\n" },
  { path: "src/app/main.py", language: 'python', code: "from billing import charge\n\ncharge.charge()\n" },
];
const EXPECT_EDGES = [
...
test("python-from-import-submodule-edge", async () => {
