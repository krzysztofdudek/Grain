...
const CASE_FILES = [
  { path: "src/billing/impl.py", language: 'python', code: "class Service:\n    pass\n" },
  { path: "src/billing/__init__.py", language: 'python', code: "from .impl import Service\n" },
  { path: "src/app/main.py", language: 'python', code: "from billing import Service\n\nService()\n" },
];
const EXPECT_EDGES = [
...
test("python-reexport-chain-edge", async () => {
