...
const CASE_FILES = [
  { path: "src/app/__init__.py", language: 'python', code: "pass\n" },
  { path: "src/app/helper.py", language: 'python', code: "def assist():\n    pass\n" },
  { path: "src/app/main.py", language: 'python', code: "from . import helper\n\nhelper.assist()\n" },
];
const EXPECT_EDGES = [
...
test("python-intra-node-import-silence", async () => {
