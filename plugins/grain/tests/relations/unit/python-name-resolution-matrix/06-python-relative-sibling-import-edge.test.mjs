...
const CASE_FILES = [
  { path: "src/orders/pay/__init__.py", language: 'python', code: "pass\n" },
  { path: "src/orders/pay/charge.py", language: 'python', code: "def charge():\n    pass\n" },
  { path: "src/orders/handler.py", language: 'python', code: "from .pay import charge\n\ncharge.charge()\n" },
];
const EXPECT_EDGES = [
  { fromFile: "src/orders/handler.py", line: 1, node: "pay" },
];
const EXPECT_SILENCE = false;

test("python-relative-sibling-import-edge", async () => {
