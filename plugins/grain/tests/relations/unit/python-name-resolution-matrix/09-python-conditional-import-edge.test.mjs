...
const CASE_FILES = [
  { path: "src/billing/charge.py", language: 'python', code: "def charge():\n    pass\n" },
  { path: "src/shipping/label.py", language: 'python', code: "def label():\n    pass\n" },
  { path: "src/app/main.py", language: 'python', code: "try:\n    import billing.charge\nexcept ImportError:\n    import shipping.label\n" },
];
const EXPECT_EDGES = [
  { fromFile: "src/app/main.py", line: 2, node: "billing" },
  { fromFile: "src/app/main.py", line: 4, node: "shipping" },
];
const EXPECT_SILENCE = false;

test("python-conditional-import-edge", async () => {
