...
const CASE_FILES = [
  { path: "src/billing/__init__.py", language: 'python', code: "def charge():\n    pass\n" },
  { path: "src/shipping/__init__.py", language: 'python', code: "def label():\n    pass\n" },
  { path: "src/app/main.py", language: 'python', code: "import billing, shipping\n" },
];
const EXPECT_EDGES = [
  { fromFile: "src/app/main.py", line: 1, node: "billing" },
  { fromFile: "src/app/main.py", line: 1, node: "shipping" },
];
const EXPECT_SILENCE = false;

test("python-multi-name-import-edge", async () => {
