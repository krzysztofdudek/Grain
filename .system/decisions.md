...
LEKCJA (dyrektor, 2026-09-05): premerge.mjs uruchomiony z WNĘTRZA worktree gałęzi wykrywa root jako ten worktree i wpisuje nowe testy do drzewa, w którym implementacja już istnieje — revert-test pokazuje '0 fail / 11 tests' i wygląda jak brak dowodu czerwono-zielonego, choć to artefakt. Regułą: premerge zawsze z głównego checkoutu (<grain>), z --base <gałąź sesji>. Do dopisania w narzędziu: odmowa, gdy root jest worktree (.git jest plikiem).
