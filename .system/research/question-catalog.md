...
| private-repo `4104e8c4` | 3 (`replay`, `replay2`, `replay3`) | admin-only route into the admin area from the brief header |
| private-repo `10509874` | 3 (`replay`, `replay2`, `replay3`) | let users skip a section without blocking completion |
...
The six private-repo runs are the realistic end of the corpus: a private monorepo whose history begins
